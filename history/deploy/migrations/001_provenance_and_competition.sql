...
create table football_src.source (
  ...
  -- The registry's vocabulary (history/registry/sources.v1.json legend).
  -- 'rejected' = we assessed it and will not use it; 'do_not_use' = the terms
  -- forbid it. Both are refusals, and they are not the same refusal.
