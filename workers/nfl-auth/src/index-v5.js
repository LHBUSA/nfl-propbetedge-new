...
/* Standard PropBetEdge sign-off: always BELOW the sign-in CTA and the expiry/security line. */
export const EMAIL_SIGNOFF_HTML='<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-top:24px;border-top:1px solid #232a33"><tr><td style="padding-top:14px;font-family:Arial,sans-serif;font-size:11px;line-height:1.6;color:#737b86"><strong style="color:#9aa2ad">PropBetEdge</strong><br>The Sports Intelligence Network<br><a href="https://propbetedge.ai" style="color:#9aa2ad;text-decoration:underline">propbetedge.ai</a> &middot; X: <a href="https://x.com/PROPBETEDGE" style="color:#d8b75b;text-decoration:none">@PROPBETEDGE</a></td></tr></table>';
export const EMAIL_SIGNOFF_TEXT='\n\n--\nPropBetEdge\nThe Sports Intelligence Network\nhttps://propbetedge.ai\nX: @PROPBETEDGE — https://x.com/PROPBETEDGE';
export function mailHtml(link,purpose){const title=purpose==='purchase'?'Your NFL Pro access is ready.':'Your secure NFL sign-in is ready.';const copy=purpose==='purchase'?'Stripe has confirmed your NFL Pro purchase. Use this secure link to open PropBetEdge NFL with the same email used at checkout.':'Use this secure link to open your PropBetEdge NFL account.';return`<!doctype html><html><body style="margin:0;background:#080b10;color:#f7f3ea;font-family:Arial"><table width="100%" cellpadding="0" cellspacing="0" style="padding:36px 16px;background:#080b10"><tr><td align="center"><table width="100%" style="max-width:620px;background:#11161d;border:1px solid #3a301c;border-radius:18px;padding:32px"><tr><td><div style="color:#d8b75b;font-size:11px;font-weight:800;letter-spacing:2px">PROPBETEDGE NFL · SECURE ACCESS</div><h1 style="font-size:36px;line-height:1.05;margin:12px 0;color:#fff">${title}</h1><p style="color:#b7bec7;font-size:15px;line-height:1.65">${copy}</p><a href="${link}" style="display:inline-block;margin-top:10px;padding:15px 22px;border-radius:9px;background:#d8b75b;color:#161008;text-decoration:none;font-weight:900">OPEN PROPBETEDGE NFL</a><p style="margin-top:24px;color:#737b86;font-size:11px;line-height:1.6">This link expires in 15 minutes. If you did not request or purchase NFL Pro, ignore this message.</p>${EMAIL_SIGNOFF_HTML}</td></tr></table></td></tr></table></body></html>`}
export function mailText(link,purpose){return`${purpose==='purchase'?'Your PropBetEdge NFL Pro purchase is confirmed.':'Your PropBetEdge NFL sign-in link is ready.'}\n\nOpen NFL:\n${link}\n\nThis secure link expires in 15 minutes.${EMAIL_SIGNOFF_TEXT}`}
