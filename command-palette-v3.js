...
(() => {
  ...
  function pageMeta(route,title){
    const map={
      home:['NFL Intelligence OS overview','⌂'],changes:['Sourced injury, game-status, market and weather changes','△'],bestline:['Best available price vs market consensus','≡'],propboard:['Current sportsbook market desk','↗'],matchups:['Selected-event market + news + archive context','◫'],picks:['Production PBE model audit','◈'],simulator:['Model-derived line sensitivity · NFL Pro','⌁'],usage:['Who is gaining or losing targets, carries and red-zone chances','▥'],propchain:['Change → entity → market tape → best line → PBE model','◇'],pbecast:['Selected event score state + market + news','◉'],injuries:['Current NEWS injury developments','＋'],trades:['Current transactions + roster movement','⇄'],teams:['32 NFL franchise research directory','⬡'],stats:['Current-season statistical leaders','▦'],standings:['Current-season division standings','▥'],stats2025:['2025 final statistical archive','▦'],standings2025:['2025 final standings archive','▥'],seasonhistory:['Champions, MVPs, awards and leaders','▤'],hof:['Canton induction archive','★'],records:['NFL all-time record book','↗'],prospects:['Draft data review state','⌖'],sb:['Championship archive','◆']
    };
  ...
  function archivePlayers(){
    ...
    /* Only the provenanced 2025 dataset is indexed. Hall of Fame, MVP history,
       record holders and Super Bowl MVPs came from archive datasets with no
       provenance, so they are not searchable as facts. */
